import {ifNotDefined, type MetaArg, MetadataLibrary} from "../util/metal";
...
export function Middleware(...middlewares: Array<Middleware | MiddlewareFn>) { return function (t: any, p?: string) { metal.set(CMD_MIDDLEWARE_KEY, middlewares, t, p) }}
