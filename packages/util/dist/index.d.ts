 ...
 */
export declare function getUniqueFilename(inDir: string, filename: string): Promise<string>;
/**
 * @deprecated use fse.path.join() instead
 * This method joins a
 * @param args
 */
export declare function joinPath(...args: NonEmptyArray<string>): string;
/**
...
/**
 * @deprecated use fse.mimeType.lookup instead
 */
export declare function mimeTypeLookup(filename: string): string;
/**
 * @deprecated use fse.mimeType.map instead
 */
export declare let mimeTypeMap: Record<string, string>;
...
export declare let fse: {
	...
	rmEmptyParents: (dir: string) => void;
	tmpFileCreatorFactory: (tmp: string) => TmpFileCreator;
};
declare class TmpFile$1 {
	file: string;
	get filename(): string;
	constructor(file: string);
	release(): Promise<void>;
...
declare class TmpFileCreator {
	...
	constructor(path: string);
	get targetDir(): Promise<string>;
	createFromFile(file: File, removeOriginal?: boolean): Promise<TmpFile$1>;
	createFromBuffer(filename: string, buffer: Buffer): Promise<TmpFile$1>;
	createFromFilePath(file: string, removeOriginal?: boolean): Promise<TmpFile$1>;
}
